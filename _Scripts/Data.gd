...
const SPAWN_RATES_ENEMIES := [[90.0, 100.0, 100.0, 100.0], [75.0, 100.0, 100.0, 100.0], [50.0, 100.0, 100.0, 100.0],
	[25.0, 90.0, 100.0, 100.0], [5.0, 75.0, 95.0, 100.0], [0.0, 50.0, 75.0, 100.0], [0.0, 25.0, 60.0, 100.0],
	[0.0, 10.0, 55.0, 100.0], [0.0, 5.0, 55.0, 100.0], [0.0, 0.0, 45.0, 100.0], [0.0, 0.0, 35.0, 100.0],
	[0.0, 0.0, 25.0, 100.0]]

const LOOT_RATES := [[20.0, 40.0, 60.0, 80.0, 100.0, 0.0], [25.0, 50.0, 55.0, 60.0, 90.0, 100.0],
	[5.0, 10.0, 15.0, 20.0, 70.0, 100.0], [0.0, 0.0, 0.0, 0.0, 50.0, 100.0]]
